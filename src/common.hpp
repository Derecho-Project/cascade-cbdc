...
// client latency/throughput tags (signed receipt + terminal status)
#define CBDC_TAG_CLIENT_PUT_START        100160
#define CBDC_TAG_CLIENT_PUT_REPLY        100161
#define CBDC_TAG_CLIENT_SIG_WAIT_START   100162
#define CBDC_TAG_CLIENT_SIG_FIRED        100163
#define CBDC_TAG_CLIENT_HASH_GET_DONE    100164
#define CBDC_TAG_CLIENT_VERIFY_DONE      100165
#define CBDC_TAG_CLIENT_VERIFY_FAIL      100166
